    ...
    <div className="absolute top-0 left-0 h-full w-full  p-8 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex justify-between">
          <button style={{backgroundColor:props.color}} className=" text-white font-semibold px-8 py-2 rounded-full ">
            {props.tag}
          </button>
          <button className=" text-white font-semibold px-4 py-3 rounded-full">
